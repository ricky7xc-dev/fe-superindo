...
import { deleteProductCategory } from "../../redux/slices/productCategoriesSlice";
import {
  fetchProduct,
  setEditingProduct,
  deleteProduct,
...
const ProductCategories = () => {
  ...
  const [isModalOpenVariant, setIsModalOpenVariant] = useState(false);
  ...
  useEffect(() => {
    ...
    dispatch(fetchProduct(current_page));
  }, [dispatch, current_page, isModalOpen, isModalOpenVariant]);
  ...
  const toggleModalVariant = () => {
    setIsModalOpenVariant(!isModalOpenVariant);
    // dispatch(setEditingProduct(null));
  };
